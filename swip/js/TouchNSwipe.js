...
(function(window)
{
	...
	function ImageSlider(slider, _slides, varsObj)
	{
		...
		function resetImages()
		{
			...
			console.log(_slideIndex, _slides[_slideIndex].image[0].alt);

			if(_slides[_slideIndex].image[0].alt == "video")
			{
				var path = _slides[_slideIndex].image[0].path;
console.log(path);
				$(".slides").children().children("div:nth-child(3)").html("<video controls src='assets/7.mp4'></video>");
			}
		}
		...
		$('a[href="#recipe_portion1"]').click(function() {
			_index(0, true);
		});
		$('a[href="#recipe_portion2"]').click(function() {
			_index(1, true);
		});
		$('a[href="#recipe_togo1"]').click(function() {
			_index(2, true);
		});
		$('a[href="#recipe_togo2"]').click(function() {
			_index(3, true);
		});
		$('a[href="#recipe_grill"]').click(function() {
			_index(4, true);
		});
		$('a[href="#recipe_lead"]').click(function() {
			_index(5, true);
		});
		$('a[href="#recipe_prep"]').click(function() {
			_index(6, true);
		});
		$('a[href="#recipe_salad"]').click(function() {
			_index(7, true);
		});
		$('a[href="#recipe_traning"]').click(function() {
			_index(8, true);
		});
	}
