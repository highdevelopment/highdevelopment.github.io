...
var vCardString = (function() {
    var testCard = require('./vcard');
    var assert = require('assert');
    var testCard = testCard();

    function initVCardData(data) {
        testCard.version = '3.0';
        testCard.lastName = data.lastName;
        // testCard.middleName = '';
        testCard.firstName = data.firstName;
        // testCard.nameSuffix = 'JR';
        // testCard.namePrefix = 'MR';
        // testCard.nickname = data.nickname;
        // testCard.gender = 'M';
        testCard.organization = data.organization;
        // testCard.photo.attachFromUrl('https://testurl', 'png');
        // testCard.logo.attachFromUrl('https://testurl', 'png');
        testCard.workPhone = data.workPhone;
        // testCard.homePhone = data.homePhone;
        ...
        testCard.email = data.email;
        // testCard.workEmail = 'john.doe@workmail';
        // testCard.url = data.url;
    ...
    return {
        getString: function(data) {
            initVCardData(data);
            return testCard.getFormattedString();
        }
    };
