    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            if (showLegend) {
                ...
                ////////////////////////////////////////////////////////////////////////
                // EDIT HERE FOR LINECHART LEGEND POSITION
                ////////////////////////////////////////////////////////////////////////
                wrap.select('.nv-legendWrap')
            ...
            if (showYAxis) {
                ...
                // remove the minimum element from the axis
                g.select(".nv-axisMaxMin")
                    .select("text")
                    .text("");
   
                g.select(".nv-axisMaxMin-y")
                    .select("text")
                    .text("");
                /*
                g.select(".nv-axis").select("line")
                    .style("stroke", "blue");
                    */
            }
            ...
            interactiveLayer.dispatch.on('elementMousemove', function(e) {
                ...
                */
                var xValue = xAxis.tickFormat()(chart.x()(singlePoint,pointIndex));
                if (pointXLocation > width / 2) {
                    //console.log(interactiveLayer.tooltip.tooltipElem());
                interactiveLayer.tooltip
                      .position({left: pointXLocation - width + 100, top: e.mouseY + margin.top})
                      .chartContainer(that.parentNode)
                      .valueFormatter(function(d,i) {
                         return yAxis.tickFormat()(d);
                      })
                    ...
                    interactiveLayer.tooltip
                      .position({left: pointXLocation - 30, top: e.mouseY + margin.top})
                         .chartContainer(that.parentNode)
                      .valueFormatter(function(d,i) {
                         return yAxis.tickFormat()(d);
                      })
