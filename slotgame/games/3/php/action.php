<?php
    ...
    function _initSettings(){
        $_SESSION["iMoney"] = 5000;          //USER MONEY
        ...
        $_SESSION["coin_bet"] = [1, 2, 5, 10, 25, 50, 75, 100]; //THIS IS THE LIST OF COIN BETS.

        $_SESSION["wild_symbol"] = 16;
        $_SESSION["bonus_symbol"] = 15;
    ...
    function _initSymbolsOccurence(){
        ...
        for($i=0;$i<1;$i++){
            array_push($_SESSION["rand_symbols"],11);
        }

        //OCCURENCE FOR SYMBOL 12
        for($i=0;$i<1;$i++){
            array_push($_SESSION["rand_symbols"],12);
        }

        //OCCURENCE FOR SYMBOL 13
        for($i=0;$i<1;$i++){
            array_push($_SESSION["rand_symbols"],13);
        }

        //OCCURENCE FOR SYMBOL 14
        for($i=0;$i<1;$i++){
            array_push($_SESSION["rand_symbols"],14);
        }

        //OCCURENCE FOR SYMBOL 15
        for($i=0;$i<1;$i++){
            array_push($_SESSION["rand_symbols"],15);
        }

        //OCCURENCE FOR SYMBOL 16
        for($i=0;$i<1;$i++){
            array_push($_SESSION["rand_symbols"],16);
        }
    }
    ...
    function _initSymbolWin(){
        ...
        $_SESSION["symbolwin"][8] = array(0,10,20,30,40);
        $_SESSION["symbolwin"][9] = array(0,30,60,90,120);
        $_SESSION["symbolwin"][10] = array(0,0,0,0,0,50);
        $_SESSION["symbolwin"][11] = array(0,0,0,0,0,50);
    };
